  ...
  describe '#run' do
    ...
    context 'when tournament has no champion_team' do
      ...
      it 'should calculate results of tips and update ranking for match of given match_id' do
        ...
        tip_result_service = LegacyTipResultService.new(match_id: nil)
        LegacyTipResultService.should_receive(:new).with(match_id: match_id).and_return(tip_result_service)
