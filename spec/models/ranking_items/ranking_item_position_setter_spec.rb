describe RankingItemPositionSetter do
  ...
  let(:ranking_items) do
    [
        RankingItem.new(
            ...
            correct_tendency_tips_only_count: 99,
        ...
        RankingItem.new(
            ...
            correct_tendency_tips_only_count: 100,
  ...
  describe '::set_positions!' do
    ...
    it 'should return sorted ranking items with position set' do
      ...
      expect(sorted_ranking_items[6]).to eq ranking_items[6]
      expect(sorted_ranking_items[6].position).to be 7
    end
  end
end