class PlayerPermissions
  ...
  def configure_permissions
    ...
    #attributes
    allow_attributes :user, [:email, :nickname, :first_name, :last_name, :current_password, :password, :password_confirmation, :remember_me, :match_sort]
